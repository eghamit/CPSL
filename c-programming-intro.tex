...
\begin{document}
	...
	\begin{frame}{Comparing the Three Levels}
		...
		\begin{tabular}{@{}p{2.4cm}p{4.0cm}p{5.0cm}@{}}
			...
			Assembly  & Hard (mnemonics)             & \texttt{MOV AL, 61$^\text{H}$}\quad \texttt{ADD AL, BL} \\
	...
	\begin{frame}{Structured Programming}
		...
		\begin{columns}[T]
			...
			\begin{column}{0.4\textwidth}
				...
				\begin{tikzpicture}[font=\scriptsize, node distance=0.4cm,
					dsm/.style={diamond, aspect=1.6, draw=black, fill=cGreen!18, minimum width=1.6cm, inner sep=0pt}]
					\node[dsm] (d){cond?};
					\node[process, fill=cGreen!12, below left=0.5cm and 0cm of d, minimum width=0.9cm, text width=0.7cm](y){yes};
					\node[process, fill=cRed!12, below right=0.5cm and 0cm of d, minimum width=0.9cm, text width=0.6cm](n){no};
			...
			\begin{column}{0.28\textwidth}
				...
				\begin{tikzpicture}[font=\scriptsize, node distance=0.5cm,
					dsm/.style={diamond, aspect=1.6, draw=black, fill=cGreen!18, minimum width=1.6cm, inner sep=0pt}]
					\node[dsm] (l){cond?};
					\node[process, fill=cOrange!14, below=0.6cm of l, minimum width=1.3cm](body){body};
